...
*/
console.log(createMenuItem('Baja Blast',4,'Drink'));
console.log(createMenuItem('Cookies',2,'Snack'));
console.log(createMenuItem('Hamburger', 10, 'Dinner'))
...
*/
reviews.feedback = 'this place is chill with really cool people, great for getting work done on weekdays'
console.log(reviews)
